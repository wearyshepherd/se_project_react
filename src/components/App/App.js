...
const App = () => {
  ...
  const handleTempConversion = (temp, unit) => {
    if (unit === 'C') {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const convertedTemp = handleTempConversion(parsedTemp, currentTemperatureUnit);
    ...
    fetchData();
  }, [currentTemperatureUnit]); // Fetch weather data whenever temperature unit changes
